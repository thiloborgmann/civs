...
BEGIN {
    ...
    $recorded_voters $ballot_reporting $reveal_voters $reveal_ballot_id $authorization_key
...
our ($name, $title, $email_addr, $description, $num_winners, $addresses,
     ...
     $num_votes, $recorded_voters, $ballot_reporting, $reveal_voters, $reveal_ballot_id,
...
sub init {
    ...
    $reveal_ballot_id = $edata{'reveal_ballot_id'} or $reveal_ballot_id = '';
